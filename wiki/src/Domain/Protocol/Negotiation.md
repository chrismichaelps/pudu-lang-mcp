---
type: module
path: "@root/src/Domain/Protocol/Negotiation.pudu"
fidelity: Active
...
- **Requires:** [[src/Constants/Protocol]], [[src/Errors/RpcError]], [[src/Utils/JsonAccess]].
...
- A modern request for `initialize` is admitted as `Modern`; [[src/App/Dispatch]] answers
...
[[src/Domain/Protocol/_MOC]] · [[domain/ProtocolEra]]
