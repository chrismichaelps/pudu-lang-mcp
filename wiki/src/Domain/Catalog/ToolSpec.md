---
type: module
path: "@root/src/Domain/Catalog/ToolSpec.pudu"
fidelity: Active
domain: "[[domain/Tool]]"
...
the rules [[src/Domain/Catalog/Arguments]] validates against.
...
- **Requires:** `Std.Json`, [[src/Utils/JsonAccess]].
- **Consumed by:** [[src/Domain/Catalog/Tools]], [[src/Domain/Catalog/Arguments]].
