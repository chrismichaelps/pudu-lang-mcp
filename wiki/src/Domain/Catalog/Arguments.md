---
type: module
path: "@root/src/Domain/Catalog/Arguments.pudu"
fidelity: Active
domain: "[[domain/Tool]]"
...
Validate a `tools/call` `arguments` value against its [[src/Domain/Catalog/ToolSpec]], and hand
...
- **Requires:** [[src/Domain/Catalog/ToolSpec]], [[src/Errors/ToolError]], [[src/Utils/JsonAccess]].
- **Consumed by:** [[src/App/Tools/Registry]] and every tool handler.
