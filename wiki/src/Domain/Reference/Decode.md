---
type: module
path: "@root/src/Domain/Reference/Decode.pudu"
fidelity: Active
...
public [[src/Domain/Reference/Entry]]s those files declare
...
- **Requires:** [[src/Domain/Reference/Entry]], `Std.Json`.
- **Consumed by:** [[src/Services/Reference]].
