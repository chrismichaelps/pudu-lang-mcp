---
type: module
path: "@root/src/Domain/Reference/Entry.pudu"
fidelity: Active
...
- **Consumed by:** [[src/Services/Reference]], [[src/App/Tools/Stdlib]], [[src/App/Resources]], [[src/App/Completion]].
...
- **Q:** Why not always call `pudu search`? **A:** Name lookups over the compiled catalogue need
  ...
  which unifies shapes ([[src/App/Tools/Stdlib]]).
