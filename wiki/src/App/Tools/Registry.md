---
type: module
path: "@root/src/App/Tools/Registry.pudu"
fidelity: Active
domain: "[[domain/Tool]]"
...
- **Requires:** [[src/Domain/Catalog/Tools]], [[src/Domain/Catalog/ToolSpec]], [[src/Domain/Catalog/Arguments]], [[src/Domain/Protocol/Pagination]], [[src/Domain/Rpc/Reply]], every `App/Tools/*` handler.
- **Consumed by:** [[src/App/Dispatch]].

## Algorithm

- `list`: page the catalogue ([[src/Domain/Protocol/Pagination]], `PAGE_SIZE`) and answer
...
[[src/App/Tools/_MOC]] · [[src/App/Dispatch]]
