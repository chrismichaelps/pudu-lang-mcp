---
type: module
path: "@root/src/App/Tools/Docs.pudu"
fidelity: Active
domain: "[[domain/Tool]]"
...
- **Requires:** [[src/App/Context]], [[src/Domain/Docs/Chapter]], [[src/Domain/Docs/Search]], [[src/Domain/Catalog/Arguments]], [[src/Utils/TextBounds]], [[src/Constants/Server]].
- **Consumed by:** [[src/App/Tools/Registry]], [[src/App/Completion]].

## Algorithm

- `search`: `group`, when given, must be one of `GROUPS` (`OutOfRange`). Rank the sections of that
  group (or all) with [[src/Domain/Docs/Search]] and `limit` (default `DEFAULT_SEARCH_LIMIT`). Each
