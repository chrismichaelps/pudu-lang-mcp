---
type: module
path: "@root/src/App/Resources.pudu"
fidelity: Active
...
- **Requires:** [[src/App/Context]], [[src/App/Tools/Reference]], [[src/Domain/Docs/Chapter]], [[src/Domain/Protocol/Pagination]], [[src/Domain/Rpc/Reply]], [[src/Utils/Uri]].
- **Consumed by:** [[src/App/Dispatch]], [[src/App/Completion]].
...
- **Q:** List every module as a resource? **A:** No; 174 and growing with packages. A template
  plus completion ([[src/App/Completion]]) names them on demand.
