---
type: module
path: "@root/src/Services/Toolchain.pudu"
fidelity: Active
...
- **Requires:** [[src/Services/Process/Bounded]], [[src/Constants/Server]], `Std.Env`, `Std.Fs`, `Std.Io`, `Std.Path`.
- **Consumed by:** [[src/Main]], [[src/Services/Lsp]], [[src/Services/Reference]], `App/Tools/*`.
...
4. `run` calls [[src/Services/Process/Bounded]] with the compiler and the caller's output cap; with no
...
[[src/Services/_MOC]] · [[seams/Toolchain]] · [[domain/Toolchain]]
