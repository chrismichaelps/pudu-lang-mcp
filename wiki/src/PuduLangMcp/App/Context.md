---
type: module
path: "@root/src/PuduLangMcp/App/Context.pudu"
fidelity: Active
...
- **Requires:** [[src/PuduLangMcp/Services/Toolchain]], [[src/PuduLangMcp/Services/Workspace]], [[src/PuduLangMcp/Services/Reference]], [[src/PuduLangMcp/Domain/Docs/Chapter]], [[src/PuduLangMcp/Domain/Reference/Entry]], [[src/PuduLangMcp/Errors/ToolError]], `Std.Concurrent`, `Std.Sync`.
- **Consumed by:** [[src/Main]], [[src/PuduLangMcp/App/Dispatch]], every `App` handler.

## Algorithm

- `create` splits the corpus into sections, lists the module files, and starts one background task
  that builds the index ([[src/PuduLangMcp/Services/Reference]]) and stores `Ready` or `Broken`. With no
