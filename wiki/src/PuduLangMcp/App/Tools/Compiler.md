---
type: module
path: "@root/src/PuduLangMcp/App/Tools/Compiler.pudu"
fidelity: Active
domain: "[[domain/Tool]]"
...
- **Requires:** [[src/PuduLangMcp/App/Context]], [[src/PuduLangMcp/Services/Workspace]], [[src/PuduLangMcp/Services/Toolchain]], [[src/PuduLangMcp/Domain/Catalog/Arguments]], [[src/PuduLangMcp/Utils/TextBounds]], [[src/PuduLangMcp/Constants/Server]].
...
[[src/PuduLangMcp/Services/Workspace]] `withTarget` places the code, and the command runs in the target's
