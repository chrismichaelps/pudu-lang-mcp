---
type: module
path: "@root/src/PuduLangMcp/Errors/RpcError.pudu"
fidelity: Active
...
- **Requires:** [[src/PuduLangMcp/Constants/Protocol]], `Std.Json`.
- **Consumed by:** [[src/PuduLangMcp/Domain/Rpc/Reply]], [[src/PuduLangMcp/Domain/Protocol/Negotiation]], `App/*`.
